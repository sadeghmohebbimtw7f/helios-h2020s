...
### Video Call:
This part of the app creates a P2P video call between two users connected to the same signalling server. The default configuration is the following:
...
`implementation 'eu.h2020.helios_social.modules.videocall:videocall:1.0.27'`
